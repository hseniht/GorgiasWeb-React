...
export class AppDownloadBanner extends React.Component {
  render (){
    return (
                      <div className="section mcb-section" id="download" style={{paddingTop:50+"px", paddingBottom:50+"px", backgroundRepeat:"no-repeat", backgroundPosition:"center",backgroundSize:"cover",backgroundColor:"#333"}}>
