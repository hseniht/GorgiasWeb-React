    ...
    return (
        <div className="content_wrapper clearfix">
            <div className="sections_group">
              <div className="entry-content tk-background-ImgFit" style={{backgroundImage:"url(https://gorgiasasia.blob.core.windows.net/images/webcover-1109?timestamp=403)"}}>
                {/*login*/}
                <div className="section dark" id="featured" style={{height: 100+"vh", backgroundColor:"rgba(0, 0, 0, 0.5)", backgroundRepeat:"no-repeat", backgroundPosition:"center top", backgroundSize:"cover"}}>
                            ...
                            <div id="tk-overlay-form">
                               <form>
                                 ...
                                 <div className="column one" style={{margin:0}}>
                                     <input type="submit" value="Access to Private App" id="submit" className="tkFont-Bold" onClick="return check_values();"/>
                                 </div>
