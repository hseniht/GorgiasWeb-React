...
export class ContactTextBanner extends React.Component {
  render (){
    return (
                    ...
                    <div className="items_group clearfix">
                        <div className="column one column_column ">
                            <div className="column_attr align_center">
                                <h3 className="tkFont1" style={{color:"black",fontSize:" x-large"}}>WE'D <span><img src="tkImages/3_Touch_For_Love.png" height="42" alt="love" width="42"/></span> TO HELP</h3>
                                ...
                                <h3 className= "tkFont1" style={{color:"black"}}>OR WRITE US ON <a className="themecolor" href="#">email@gorgias.com</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
